...
/** Additional storage action since maildrop does not support the "c-flag" as
 * in procmail. */
 ...
 *
 * $Horde: ingo/lib/Script/maildrop.php,v 1.7.2.7 2007/01/02 13:55:03 jan Exp $
 *
...
class Maildrop_Recipe {
    ...
    function Maildrop_Recipe($params = array(), $scriptparams = array())
    {
        ...
        case MAILDROP_STORAGE_ACTION_STOREANDFORWARD:
            ...
            /* The 'to' must be the last action, because maildrop stops
               processing after it. */
    ...
    function generate()
    {
        ...
        if (count($this->_conditions > 1)) {
            ...
            foreach ($this->_conditions as $condition) {
                ...
                $text[] = $cond . $condition['condition'] . ':h' . $condition['flags'] . " \\";
                $nest = true;
            }
        }
