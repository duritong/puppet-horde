 ...
 * </code>
 *
 * $Horde: framework/VFS/VFS/musql.php,v 1.30.4.17 2007/01/02 13:54:48 jan Exp $
 *
...
class VFS_musql extends VFS_sql {
                        ...
                        $dironly = false)
    {
        ...
        $fileList = $this->_db->getAll(sprintf('SELECT vfs_name, vfs_type, vfs_modified, vfs_owner, vfs_perms, %s(vfs_data) FROM %s
