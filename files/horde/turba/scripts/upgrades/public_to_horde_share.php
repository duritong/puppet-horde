...
<?php
/**
 * $Horde: turba/scripts/upgrades/public_to_horde_share.php,v 1.3.2.6 2007/01/02 13:55:19 jan Exp $
 *
...
// Now that we are authenticated, we can Turba's base. Otherwise,
// the share code breaks, causing a new, completly empty share to be
