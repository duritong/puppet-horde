 ...
 *
 * $Horde: framework/UI/UI/Tabs.php,v 1.27.6.11 2007/01/02 13:54:46 jan Exp $
 *
...
class Horde_UI_Tabs extends Horde_UI_Widget {
     ...
     *                         or a hash of parameters. If an array, the tab variable
     *                         can be set by the 'tabname' key.
     */
