 ...
 *
 * $Horde: ingo/lib/Script.php,v 1.30.10.8 2006/01/31 20:00:24 jan Exp $
 *
...
class Ingo_Script {
    ...
    function &factory($script, $params = array())
    {
        ...
        if (class_exists($class)) {
            ...
            $ingo = PEAR::raiseError(sprintf(_("Unable to load the definition of %s."), $class));
        }
     ...
     * based on $script.
     *
     * It will only create a new instance if no Ingo_Script instance with the
     * same parameters currently exists.
     *
     * This method must be invoked as: $var = &Ingo_Script::singleton()
     *
     * @param string $script  The type of concrete Ingo_Script subclass to
     *                        return.
     * @param array $params   A hash containing additional parameters for the
     *                        subclass.
     *
     * @return Ingo_Script  The concrete Ingo_Script reference, or false on
     *                      error.
     */
