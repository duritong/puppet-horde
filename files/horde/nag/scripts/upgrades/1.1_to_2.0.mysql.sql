-- $Horde: nag/scripts/upgrades/1.1_to_2.0.mysql.sql,v 1.6.2.2 2005/10/18 12:56:50 jan Exp $
--
...
ALTER TABLE nag_tasks CHANGE COLUMN task_private task_private SMALLINT NOT NULL default 0;
