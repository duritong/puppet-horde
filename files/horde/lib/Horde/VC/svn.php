 ...
 *
 * $Horde: framework/VC/VC/svn.php,v 1.28.4.20 2007/04/16 05:29:39 chuck Exp $
 *
...
class VC_Diff_svn {
                 ...
                 $ws = true)
    {
        ...
        $Q = VC_WINDOWS ? '"' : "'";
        $command = $rep->getPath('svn') . " diff --diff-cmd " . $rep->getPath('diff') . " -r $rev1:$rev2 -x " . $Q . $options . $Q . ' ' . $Q . $file->queryFullPath() . $Q . ' 2>&1';
