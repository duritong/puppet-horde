 ...
 *
 * $Horde: framework/Crypt/Crypt/smime.php,v 1.49.2.14 2007/08/15 08:51:52 selsky Exp $
 *
...
class Horde_Crypt_smime extends Horde_Crypt {
     ...
     *
     * @return string  Returns the email address, or null if none is found.
     */
